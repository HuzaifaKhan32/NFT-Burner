      ...
      {isOpen && (
        ...
        >
          <motion.div 
            ...
            className="relative w-full max-w-md glass-sharp-gold rounded-3xl p-6 sm:p-8 text-white overflow-hidden shadow-2xl border border-[#e9c176]/40"
          >
            <button
              onClick={onClose}
              ...
              <div className="space-y-4">
                <div className="p-4 rounded-2xl bg-white/5 border border-white/10 space-y-3">
                  ...
                  <div className="flex items-center justify-between p-3 rounded-xl bg-black/40 border border-white/10">
                    ...
                    <button
                      ...
                      className="p-2 text-white/60 hover:text-white rounded-lg bg-white/5 hover:bg-white/10 transition-colors cursor-pointer"
                      title="Copy address"
                    >
                      <Copy size={14} />
                    </button>
                ...
                <div className="flex gap-3">
                  <button
                    ...
                    className="w-full py-3 rounded-full bg-white/10 border border-white/20 text-white/80 hover:text-white text-xs font-semibold tracking-wider uppercase hover:bg-white/20 transition-all flex items-center justify-center gap-1.5 cursor-pointer"
                  >
