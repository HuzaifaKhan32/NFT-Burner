    ...
    <section className={`min-h-screen pt-28 pb-24 px-5 lg:px-12 transition-colors duration-300 ${
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <motion.div 
          ...
          className={`p-4 rounded-2xl mb-10 flex flex-col md:flex-row items-center justify-between gap-4 ${
          ...
          <div className="flex items-center gap-2 overflow-x-auto w-full md:w-auto pb-1 md:pb-0">
            ...
            {['All', 'Mythic', 'Celestial', 'Ethereal', 'Botanical'].map(rarity => (
              <button
                ...
                className={`px-3.5 py-1.5 rounded-full text-xs font-semibold tracking-wider uppercase transition-all whitespace-nowrap cursor-pointer ${
          ...
          {inspectArtifact && (
            ...
            >
              <motion.div 
                ...
                className="relative w-full max-w-3xl glass-sharp-gold rounded-3xl p-6 sm:p-10 text-white overflow-hidden my-8 border border-[#e9c176]/40"
              >
                <button
